...
(setq
 ...
 '("emacs.el" "display.el" "simple.el" "repeatable-lite.el"
   ...
   "treemacs.el" "tokei.el" "security.el" "grep.el" "replace.el"
   "ag.el" "wgrep.el" "iedit.el" "dap-mode.el" "python.el"
   "web-mode.el" "js2-mode.el" "rjsx-mode.el" "emmet-mode.el"
   "shell.el" "sh-script.el" "foreman.el" "foreman_conf.el" "citar.el"
   ...
   "olivetti.el" "evil.el" "evil-anzu.el" "evil-surround.el"
   ...
   "awesome-tray.el" "annotate.el" "savehist.el" "eww.el"
   "consult-ls-git.el" "comint.el" "prescient.el" "ddp.el"
   "pr-review.el" "embark-vc.el" "activities.el" "jira.el"
