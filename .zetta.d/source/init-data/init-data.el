...
(setq
 user-files
 '("emacs.el" "display.el" "simple.el" "repeatable-lite.el"
   "utility.el" "interface.el" "desktop.el" "csv-mode.el"
   ...
   "display-line-numbers.el" "face.el" "vi-tilde-fringe.el"
   "treesit.el" "dimmer.el" "focus.el" "face-remap.el"
   "default-text-scale.el" "hl-line.el" "lin.el" "hide-mode-line.el"
   "all-the-icons.el" "remote.el" "minimalize.el" "treemacs.el"
   ...
   "dockerfile-mode.el" "docker-compose-mode.el" "pocket-reader.el"
   ...
   "text-mode.el" "jmespath.el" "terraform.el" "ein.el"
   "adaptive-wrap.el" "xref.el" "flycheck.el" "flycheck-indicator.el"
   "magit-diff-flycheck.el" "modern-fringes.el" "rainbow-mode.el"
   "image-mode.el" "browse-url.el" "spray.el" "mermaid-mode.el"
   "minimap.el" "kubernetes-el.el" "kubel.el" "git-link.el"
   "python-pytest.el" "multi-compile.el" "compile.el"
   "unicode-fonts.el" "spinner.el" "fancy-compilation.el" "ai.el"
   "org-ql.el" "org-capture.el" "org-ref.el" "org.el" "ob-mermaid.el"
   ...
   "magneto.el" "know-your-http-well.el" "spacetree.el" "vertico.el"
   "vterm.el" "tab-line.el" "window.el" "line.el" "snippets.el"
   "detached.el" "ace-mc.el" "json-mode.el" "jsonian.el"
   "consult-gh.el" "consult-omni.el" "speed-type.el" "spray.el"
   ...
   "project.el" "gnus.el" "gha.el" "outline-indent.el" "persist.el"
   "smerge-mode.el" "repeat-mode.el" "hl-todo.el" "dual-header.el"
   "breadcrumb.el" "parrot.el" "hl-block.el" "move-text.el"
   "awesome-tray.el" "savehist.el" "eww.el" "consult-ls-git.el"
   "comint.el" "prescient.el" "ddp.el" "pr-review.el" "embark-vc.el"
   "activities.el" "jira.el" "flappy-fish.el" "biome.el" "spot.el"
   "doric-themes.el" "graphviz-dot-mode.el" "magit-delta.el"
   "blamer.el" "git-modes.el" "vdiff-magit.el" "git-timemachine.el"
   "orgit.el" "dired-git.el" "magit-commit-mark.el" "consult-lsp.el"
   "marqueeo.el" "vundo.el" "org-remark.el" "elfeed.el" "wombag.el"
   "cleanup.el"))
