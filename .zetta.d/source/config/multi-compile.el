...
(setq zmc-extra-project-paths
      '("~/source_code/REMOVED-REPO/pipeline/patient/"
        "~/source_code/REMOVED-REPO/pipeline/dp/"
        "~/source_code/REMOVED-REPO/pipeline/hie/"
        "~/source_code/REMOVED-REPO/pipeline/order-service/"
        "~/source_code/REMOVED-REPO/pipeline/reports/"
        "~/source_code/REMOVED-REPO/pipeline/data-share/"))
