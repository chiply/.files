...
set -g status-right '#[fg=#f99157,bg=#ffffff] %H:%M |#[fg=#6699cc] %y.%m.%d '

# make background window look like white tab
set-window-option -g window-status-style bg=#ffffff
set-window-option -g window-status-style fg=black
set-window-option -g window-status-style none
set-window-option -g window-status-format '#[fg=#999999,bg=#ffffff] #I #[fg=#999999,bg=#ffffff] #W #[default]'

# make foreground window look like bold yellow foreground tab
set-window-option -g window-status-current-style none
set-window-option -g window-status-current-format '#[fg=#f99157,bg=#ffffff] #I #[fg=#000000,bg=#efefef] #W #[default]'
